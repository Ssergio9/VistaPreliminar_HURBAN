...
<div class="formulario-registrar" >
    <form class="form_r" action="edit_user.php" method="POST">
        ...
        <a href="tablaPro.php"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-left" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
