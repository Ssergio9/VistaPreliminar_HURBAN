    ...
    <main class="ctn1">
        ...
        <div class="contenedor__todo">
            <div class="contenedor__login-register">
                <form action="regHuerta.php" class="formulario__login" method="POST" enctype="multipart/form-data">
                    <h2>Nueva Huerta</h2>
                    <input class="imp0" type="text" name="idTiposHuerta" placeholder="Id de Huerta" required>
                    <input class="imp1" type="text" name="nombreTipoHuerta" placeholder="Ingrese titulo de Huerta..."><br>
                    
                    <div class="carga"><br><br>
                        <p id="p1" style="text-align: center;"><b>Imagen de Huerta</b></p>
                        <input class="img1" type="file" name="imgHuerta"><br><br>
                        <p id="p1" style="text-align: center;"><b>Formato de Huerta</b></p>
                        <input class="img1" type="file" name="formatHuerta"><br><br>
                    </div>

                    <textarea class="imp2" name="descripcionDetallada" placeholder="Descripcion detallada sobre la Huerta..."></textarea><br><br>

                    
                        <button id="bt1" type="submit" name="eliminarhu">- Eliminar Huerta</button>    
                        <button id="bt2" type="submit" name="agregarhu">+ Agregue Huerta</button>
                        <button id="bt3" type="submit" name="actualizarhu">~ Actualizar Huerta</button>
        ...
        <section class="gallery" id="galeria">
            <div class="contenedor">
                ...
                <button onclick="window.location.href = 'excelHuertas.php';">
        ...
        if ($resultado) {
            if (mysqli_num_rows($resultado) > 0) {
                ...
                while ($fila = mysqli_fetch_assoc($resultado)) {
                    ...
                    echo "<td><img height='50px' src='data:image/jpg;base64," . base64_encode($fila['imgHuerta']) . "'></td>";
